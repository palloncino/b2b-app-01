...
import CreatePreventive from "./pages/create-preventive-page.js";
import Dashboard from "./pages/dashboard-page.js";
import PreventiveArchive from "./pages/preventive-archive-page.js";
        ...
        <ThemeProvider>
          ...
          <Container component="main" maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
            <Routes>
              ...
              <Route path="/create-preventive" element={<CreatePreventive />} />
              <Route
                path="/preventive-archive"
                element={<PreventiveArchive />}
              />
